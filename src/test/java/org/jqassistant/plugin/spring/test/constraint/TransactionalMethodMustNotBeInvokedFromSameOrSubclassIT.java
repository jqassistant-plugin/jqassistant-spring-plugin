...
class TransactionalMethodMustNotBeInvokedFromSameOrSubclassIT extends AbstractJavaPluginIT {
    ...
    @ParameterizedTest
    @ValueSource(classes = {JtaJakartaTransactionalClass.class, JtaJakartaTransactionalMethod.class,
    ...
    void transactionMethodsMustNotBeCalledDirectlyWithViolations(Class<?> clazz) throws Exception {
        ...
        assertThat(row1.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");
        ...
        assertThat(row2.getColumns().get("SourceMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(clazz, "transactionalMethodCallingMethodWithAdditionalConfiguration"));
        ...
        assertThat(row2.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(clazz, "transactionalMethodWithAdditionalConfiguration"));
        ...
        assertThat(row3.getColumns().get("SourceMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(clazz, "transactionalMethodCallingMethodWithSupportsSemanticsAndAdditionalConfiguration"));
        ...
        assertThat(row3.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(clazz, "transactionalMethodWithSupportsSemanticsAndAdditionalConfiguration"));
        assertThat(row3.getColumns().get("TargetTransactionalSemantics").getLabel()).isEqualTo("SUPPORTS");
        ...
        assertThat(row4.getColumns().get("SourceTransactionalSemantics").getLabel()).isEqualTo("NEVER");
        assertThat(row4.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(clazz, "transactionalMethodWithRequiredSemantics"));
        assertThat(row4.getColumns().get("TargetTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(row4.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");
    ...
    void transactionMethodsMustNotBeCalledDirectlyWithViolationsInSubClass() throws Exception {
        ...
        assertThat(superClassRow1.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");
        ...
        assertThat(superClassRow2.getColumns().get("SourceMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalClass.class, "transactionalMethodCallingMethodWithAdditionalConfiguration"));
        assertThat(superClassRow2.getColumns().get("SourceTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(superClassRow2.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalClass.class, "transactionalMethodWithAdditionalConfiguration"));
        assertThat(superClassRow2.getColumns().get("TargetTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(superClassRow2.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");

        final Row superClassRow3 = result.getRows().get(2);
        assertThat(superClassRow3.getColumns().get("Type").getValue()).asInstanceOf(type(TypeDescriptor.class))
            .is(typeDescriptor(SpringTransactionalClass.class));
        assertThat(superClassRow3.getColumns().get("SourceMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalClass.class, "transactionalMethodCallingMethodWithSupportsSemanticsAndAdditionalConfiguration"));
        assertThat(superClassRow3.getColumns().get("SourceTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(superClassRow3.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalClass.class, "transactionalMethodWithSupportsSemanticsAndAdditionalConfiguration"));
        assertThat(superClassRow3.getColumns().get("TargetTransactionalSemantics").getLabel()).isEqualTo("SUPPORTS");
        assertThat(superClassRow3.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");

        final Row superClassRow4 = result.getRows().get(3);
        assertThat(superClassRow4.getColumns().get("Type").getValue()).asInstanceOf(type(TypeDescriptor.class))
            .is(typeDescriptor(SpringTransactionalClass.class));
        assertThat(superClassRow4.getColumns().get("SourceMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalClass.class, "transactionalMethodWithNeverSemantics"));
        assertThat(superClassRow4.getColumns().get("SourceTransactionalSemantics").getLabel()).isEqualTo("NEVER");
        assertThat(superClassRow4.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalClass.class, "transactionalMethodWithRequiredSemantics"));
        assertThat(superClassRow4.getColumns().get("TargetTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(superClassRow4.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");

        final Row subClassRow = result.getRows().get(4);
        ...
        assertThat(subClassRow.getColumns().get("SourceMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalSubClass.class, "transactionalMethodCallingMethodWithAdditionalConfiguration"));
        assertThat(subClassRow.getColumns().get("SourceTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(subClassRow.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalSubClass.class, "transactionalSubClassMethodWithAdditionalConfiguration"));
        assertThat(subClassRow.getColumns().get("TargetTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(subClassRow.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");

        final Row subClassRow2 = result.getRows().get(5);
        assertThat(subClassRow2.getColumns().get("Type").getValue()).asInstanceOf(type(TypeDescriptor.class))
            .is(typeDescriptor(SpringTransactionalSubClass.class));
        assertThat(subClassRow2.getColumns().get("SourceMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalSubClass.class, "transactionalSubClassMethodWithNeverSemantics"));
        assertThat(subClassRow2.getColumns().get("SourceTransactionalSemantics").getLabel()).isEqualTo("NEVER");
        assertThat(subClassRow2.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(SpringTransactionalSubClass.class, "transactionalSubClassMethodWithRequiredSemantics"));
        assertThat(subClassRow2.getColumns().get("TargetTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(subClassRow2.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");
    ...
    void transactionalMethodMustNotBeInvokedFromSameClassSimpleInheritance() throws Exception {
        ...
        assertThat(callingSubClassOfSimpleTransactionalClassResult.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");
        ...
        assertThat(callingSubClassOfSimpleClassWithTransactionalMethodResult.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");
        ...
        assertThat(overridingSubClassOfSimpleTransactionalClassResult.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");
        ...
        assertThat(overridingSubClassOfSimpleClassWithTransactionalMethodResult.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");
    ...
    void transactionalMethodMustNotBeInvokedFromSameClassGenericInheritance() throws Exception {
        ...
        assertThat(callingSubClassOfGenericClassWithTransactionalMethodResult.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");
        ...
        assertThat(callingSubClassOfGenericTransactionalClassResult.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");
        ...
        assertThat(overridingSubClassOfGenericTransactionalClassResult.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");
        ...
        assertThat(overridingSubClassOfGenericClassWithTransactionalMethodResult.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");
    ...
    void transactionalMethodMustNotBeInvokedFromNestedClass() throws Exception {
        ...
        assertThat(nonTransactionalMethodRow.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");

        final Row transactionalMethodWithConfigRow = result.getRows().get(1);
        assertThat(transactionalMethodWithConfigRow.getColumns().get("Type").getValue()).asInstanceOf(type(TypeDescriptor.class))
            .is(typeDescriptor(nestedClass));
        assertThat(transactionalMethodWithConfigRow.getColumns().get("SourceMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(nestedClass, "transactionalMethodCallingMethodWithAdditionalConfiguration"));
        assertThat(transactionalMethodWithConfigRow.getColumns().get("SourceTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(transactionalMethodWithConfigRow.getColumns().get("TargetTransactionalMethod").getValue()).asInstanceOf(type(MethodDescriptor.class))
            .is(methodDescriptor(clazz, "transactionalMethodWithAdditionalConfiguration"));
        assertThat(transactionalMethodWithConfigRow.getColumns().get("TargetTransactionalSemantics").getLabel()).isEqualTo("REQUIRED");
        assertThat(transactionalMethodWithConfigRow.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("true");

        final Row methodWithNeverSemanticsRow = result.getRows().get(2);
        ...
        assertThat(methodWithNeverSemanticsRow.getColumns().get("TargetMethodSetsAdditionalConfiguration").getLabel()).isEqualTo("false");
