...
class TransactionalMethodIT extends AbstractSpringIT {
    ...
    void transactionalMethod() throws Exception {
        ...
        assertThat(methods).haveExactly(1,
            methodDescriptor(SpringTransactionalMethod.class, "transactionalMethodWithAdditionalConfiguration"));
        assertThat(methods).haveExactly(1,
        ...
        assertThat(methods).haveExactly(1,
            methodDescriptor(SpringTransactionalSubClass.class, "transactionalSubClassMethodWithRequiredSemantics"));
        assertThat(methods).haveExactly(1,
            methodDescriptor(SpringTransactionalSubClass.class, "transactionalSubClassMethodWithAdditionalConfiguration"));
        assertThat(methods).haveExactly(1,
            methodDescriptor(SpringTransactionalSubClass.class, "transactionalMethodCallingMethodWithAdditionalConfiguration"));
        assertThat(methods).haveExactly(1,
        ...
        assertThat(methods).haveExactly(1,
            methodDescriptor(SpringTransactionalImplementingClass.class, "transactionalMethodCallingMethodWithAdditionalConfiguration"));
        assertThat(methods).haveExactly(1,
            methodDescriptor(SpringTransactionalImplementingClass.class, "transactionalMethodWithAdditionalConfiguration"));
        assertThat(methods).haveExactly(1,
