...
import org.jqassistant.plugin.spring.test.set.application.invalid.Controller;
import org.jqassistant.plugin.spring.test.set.application.invalid.app.Application;
